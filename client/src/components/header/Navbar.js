...
const Navbar = () => {
  ...
  const cartLength = account?.carts?.length || 0;
        ...
        <nav>
          ...
          <div className='right'>
            ...
            >
              ...
              {
                account ? <MenuItem onClick={handleClose} onClick={logoutuser}><LogoutIcon style={{ fontSize: 16, marginRight: 3 }} />Log Out</MenuItem> : ""
              }
